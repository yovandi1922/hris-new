...
<body class="bg-gray-100 dark:bg-gray-900 font-sans text-gray-900 dark:text-gray-100">
   ...
   class="flex items-center px-4 py-2 rounded-lg transition
    ...
    <i class="fas fa-check-circle mr-3"></i> Approve
                ...
                <a href="{{ route('admin.lembur') }}" class="flex items-center px-4 py-2 rounded-lg transition
                        @if(request()->routeIs('admin.lembur')) bg-blue-100 dark:bg-gray-700 text-blue-600 dark:text-white font-semibold 
                        @else hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-blue-600 @endif">
                        <i class="fas fa-check-circle mr-3"></i> Lembur
                    </a>
