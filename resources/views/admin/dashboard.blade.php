...
<div class="p-8 min-h-screen bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
  ...
  <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
    ...
    <div class="col-span-1 row-span-2 bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-md border border-gray-200 dark:border-gray-700">
      ...
      <div class="space-y-3 max-h-[500px] overflow-y-auto pr-1">
        ...
        <div class="flex items-center gap-3 p-3 bg-gray-100 dark:bg-gray-700 rounded-2xl">
          ...
          <div>
            <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">Absen <span class="text-gray-400 text-xs ml-2">8:20 AM</span></p>
            <p class="text-xs text-gray-600 dark:text-gray-300">5 Karyawan belum clock-in</p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-3 p-3 bg-gray-100 dark:bg-gray-700 rounded-2xl">
          ...
          <div>
            <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">Karyawan <span class="text-gray-400 text-xs ml-2">5:07 AM</span></p>
            <p class="text-xs text-gray-600 dark:text-gray-300">Data baru ditambahkan</p>
          </div>
        </div>
        ...
        <div class="flex items-center gap-3 p-3 bg-gray-100 dark:bg-gray-700 rounded-2xl">
          ...
          <div>
            <p class="text-sm font-semibold text-gray-800 dark:text-gray-100">Payroll <span class="text-gray-400 text-xs ml-2">12:00 PM</span></p>
            <p class="text-xs text-gray-600 dark:text-gray-300">Proses bulan Oktober belum dilakukan</p>
          </div>
        </div>
    ...
    <div class="col-span-1 bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-md border border-gray-200 dark:border-gray-700 flex flex-col items-center">
      ...
      <p class="text-gray-500 dark:text-gray-300">Sab, Oktober 18</p>
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  new Chart(document.getElementById('absensiChart'), {
    ...
    data: {
      ...
      datasets: [{ data: [1400,1380,1390,1400,1200], backgroundColor: '#fde68a', borderRadius: 10 }]
    },
    options: {
      responsive: true,
  ...
  new Chart(document.getElementById('absenDonut'), {
    ...
    data: {
      ...
      datasets: [{ data: [1200,282], backgroundColor: ['#374151','#d1d5db'], borderWidth: 0 }]
    },
